...
data class IngredientEntity(
    val item: String,
    @TypeConverters(GsonConverters::class) val amount: Double, // Amount of the ingredient
    @TypeConverters(GsonConverters::class) val unit: String // Measurement unit (e.g., grams, cups)
)
